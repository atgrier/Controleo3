...
#define writeRegister16(a, d)    \
	{                            \
		write8Command(a);        \
		write8Data(highByte(d)); \
		write8Data(lowByte(d));  \
	}
#define writeRegister16x2(a, d1, d2) \
	{                                \
		write8Command(a);            \
		write8Data(highByte(d1));    \
		write8Data(lowByte(d1));     \
		write8Data(highByte(d2));    \
		write8Data(lowByte(d2));     \
	}

...
boolean onOff = 0;
uint8_t bypassPower;
uint8_t bypassInertia;
uint8_t bypassInsulation;
  ...
  switch (screen) {
      ...
      while (1) {
        ...
        switch (getTap(SHOW_TEMPERATURE_IN_HEADER)) {
          ...
          case 5:
            ...
            break;
          case 6:
            showHelp(SCREEN_EDIT_BAKE1);
            _screenRoutine();
          case 7:
            screen = SCREEN_EDIT_BAKE2;
        }
    ...
    case SCREEN_CHOOSE_PROFILE:
      ...
      while (1) {
        ...
        switch (getTap(SHOW_TEMPERATURE_IN_HEADER)) {
          case 0:
            prefs.selectedProfile = (prefs.selectedProfile + prefs.numProfiles - 1) % prefs.numProfiles;
            savePrefs();
            break;
          case 1:
            prefs.selectedProfile = (prefs.selectedProfile + 1) % prefs.numProfiles;
            savePrefs();
            break;
          case 2:
          ...
          case 5:
            ...
            break;
          case 6:
            showHelp(SCREEN_CHOOSE_PROFILE);
            _screenRoutine();
        }
    ...
    case SCREEN_SETTINGS:
      ...
      switch (getTap(SHOW_TEMPERATURE_IN_HEADER)) {
        ...
        case 3:
          output = 0;
          screen = SCREEN_SETUP_OUTPUTS;
          break;
        case 4:
          screen = SCREEN_PID_TUNING;
          break;
        case 5:
          screen = SCREEN_ABOUT;
          break;
      ...
      while (1) {
        ...
        switch (getTap(SHOW_TEMPERATURE_IN_HEADER)) {
          ...
          case 2:
            ...
            break;
          case 3:
            showHelp(SCREEN_TEST);
            _screenRoutine();
          case 4:
            if (output + 1 < NUMBER_OF_OUTPUTS) {
              setOutput(output, 0);
              onOff = 0;
              output++;
            } else
    ...
    case SCREEN_SETUP_OUTPUTS:
      ...
      while (true) {
        ...
        switch (getTap(SHOW_TEMPERATURE_IN_HEADER)) {
          case 0:
            prefs.outputType[output] = (prefs.outputType[output] + NO_OF_TYPES - 1) % NO_OF_TYPES;
            savePrefs();
            break;
          case 1:
      ...
      while (1) {
        ...
        switch (getTap(SHOW_TEMPERATURE_IN_HEADER)) {
          ...
          case 3:
            ...
            break;
          case 4:
            showHelp(SCREEN_SERVO_OPEN);
            _screenRoutine();
          case 5:
            screen = SCREEN_SERVO_CLOSE;
      ...
      while (1) {
        ...
        switch (getTap(SHOW_TEMPERATURE_IN_HEADER)) {
          ...
          case 3:
            ...
            break;
          case 4:
            showHelp(SCREEN_LINE_FREQUENCY);
          case 5:
            screen = SCREEN_SETTINGS;
        }

  ...
  if (redraw) {
    ...
    if (lastStatusX) {
      ...
      for (uint16_t i = lastStatusX - 3; i <= lastStatusX + 3; i++)
        tft.fillRect(i, 112, 1, 16, i < 170 ? PERFORMANCE_BAD : i >= 310 ? PERFORMANCE_GOOD
                                                                         : PERFORMANCE_OKAY);
    }
...
void showLearnedNumbers() {
  ...
  result = prefs.learnedPower < 18 ? GOOD : prefs.learnedPower < 24 ? OKAY
                                                                    : BAD;
  ...
  result = prefs.learnedInertia < 46 ? GOOD : prefs.learnedInertia < 56 ? OKAY
                                                                        : BAD;
  ...
  result = prefs.learnedInsulation > 127 ? GOOD : prefs.learnedInsulation > 103 ? OKAY
                                                                                : BAD;
  ...
  strcat(buffer100Bytes, score > 90 ? "Excellent" : score > 80 ? "Very good"
                                                  : score > 70 ? "Good"
                                                  : score > 60 ? "Marginal"
                                                               : "Not that good");
